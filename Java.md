...
- **javac**: Java的编译器, 用于把java源码文件编译为java字节码文件;
...
- Java是单继承, 一个类只有一个父类;
- `extends `继承的语法: `class ChildrenClass extends FatherClass{}`
...
- 重写方法的访问修饰符: 重写函数的访问修饰符权限只能大于等于父类方法的访问权限;
